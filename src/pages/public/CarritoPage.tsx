  ...
  return (
    <div style={{ background: "#000", color: "white", minHeight: "100vh", padding: "90px 20px 70px" }}>
      <style>{`
        ...
        .btn-volver-paso {
          padding: 12px 18px; background: #0d0d1a;
          border: 1px solid #1e1b4b; border-radius: 12px;
      ...
      <div style={{ maxWidth: 680, margin: "0 auto" }}>
                ...
                <div key={i} style={{ display: "flex", alignItems: "center", flex: i < 2 ? 1 : "none" }}>
                  ...
                  {i < 2 && (
                    <div style={{
                      ...
                      marginBottom: 20, borderRadius: 99,
        ...
        {step === "confirmacion" && (
          <div style={{
            ...
            padding: "44px 32px", borderRadius: 22, textAlign: "center",
            animation: "fadeIn .4s ease",
            boxShadow: "0 0 40px rgba(5,150,105,.1)",
          }}>
            <div style={{ fontSize: 68, marginBottom: 18 }}>✅</div>
            <h2 style={{ color: "#34d399", fontSize: 22, margin: "0 0 14px", fontWeight: 800 }}>
              ¡Pago registrado!
            </h2>
            ...
            <div style={{
              ...
              borderRadius: 12, padding: "16px 22px", display: "inline-block", marginBottom: 28, textAlign: "left",
            }}>
          ...
          <>
              ...
              {carrito.map((item, i) => {
                ...
                return (
                  <div key={i} className="cart-item" style={{
                    background: "#0d0d1a", padding: "14px 18px", borderRadius: 14,
                    border: "1px solid #1e1b4b",
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                      {item.imagenUrl && (
                        <img src={item.imagenUrl} alt={item.nombre}
                          style={{ width: 46, height: 46, objectFit: "cover", borderRadius: 10, flexShrink: 0, border: "1px solid #1e1b4b" }} />
                      )}
                      <div>
                    ...
                    {(step === "carrito" || step === "datos") && (
                      <button className="remove-btn" onClick={() => quitarDelCarrito(i)}>✕</button>
                    )}
                  </div>
                );
              })}
            ...
            {step === "datos" && (
              <div style={{ background: "#0d0d1a", border: "1px solid #1e1b4b", padding: 26, borderRadius: 18 }}>
                ...
                <p style={{ color: "#475569", fontSize: 13, margin: "0 0 22px", lineHeight: 1.6 }}>
                  La asociación te contactará a estos datos para gestionar tu pedido.
                </p>
              ...
              <div style={{ background: "#0d0d1a", border: "1px solid #1e1b4b", padding: 26, borderRadius: 18 }}>
                ...
                <div style={{
                  ...
                  <p style={{ color: "#475569", fontSize: 12, margin: 0 }}>
                    Te contactamos al <strong style={{ color: "#94a3b8" }}>{celular}</strong> · CI <strong style={{ color: "#94a3b8" }}>{ci}</strong>
                  </p>
                </div>
