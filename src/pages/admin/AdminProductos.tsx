...
function ComponenteEditor({ comp, onChange, onRemove }: {
  ...
  return (
    <div style={{ background: "#0d1929", border: "1px solid #1e293b", borderRadius: 12, padding: "14px 16px", marginBottom: 10 }}>
    ...
    <div style={{ fontFamily: "'Sora', sans-serif" }}>
                    ...
                    {p.componentes?.length ? (
                      <div style={{ display: "flex", gap: 5, flexWrap: "wrap", marginBottom: 5 }}>
                        {p.componentes.map((c, i) => (
                          <span key={i} style={{ background: "#1e293b", color: "#94a3b8", fontSize: 11, padding: "2px 8px", borderRadius: 99, border: "1px solid #334155" }}>
                            {componenteLabel(c)}
                          </span>
                        ))}
                      </div>
      ...
      {open && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.7)", backdropFilter: "blur(4px)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 999, padding: 20 }}>
          <div style={{ background: "#0f172a", border: "1px solid #1e293b", padding: "28px 24px", borderRadius: 18, width: "100%", maxWidth: 520, color: "white", boxShadow: "0 24px 64px rgba(0,0,0,0.6)", maxHeight: "90vh", overflowY: "auto" }}>
            ...
            <button onClick={addComponente} style={{ width: "100%", padding: "10px", border: "2px dashed #1e293b", borderRadius: 10, background: "transparent", color: "#475569", fontSize: 13, cursor: "pointer", fontFamily: "inherit", marginBottom: 14, transition: "all 0.15s" }}
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 6 }}>
              ...
              <button onClick={() => setOpen(false)} style={{ background: "#1e293b", border: "1px solid #334155", padding: "12px 20px", borderRadius: 10, color: "#94a3b8", fontWeight: 600, cursor: "pointer", fontSize: 14, fontFamily: "inherit" }}>Cancelar</button>
            </div>
          </div>
        </div>
      )}
